...
public class ConfigUI extends MidnightConfig{
    ...
    @Entry(category = "config", min = 1024, max = 32768) public static int cacheSize = 4096;    // The size of the cache used to store audio data, use bytes as the unit, the default is 4096 bytes
     ...
     */
    @Entry(category = "config", min = 8000, max = 48000) public static int sampleRate = 16000;  // The sample rate of the microphone, the default is 16000
     ...
     * */
    @Entry(category = "config") public static boolean autoSend = true;
     ...
     */
    @Entry(category = "config", width = 300) public static String prefix = "⌈Speech Input⌋";    // The prefix to prepend in front of chat messages
