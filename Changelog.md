...
|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.20      | [fabric-api 0.83.0+1.20](https://modrinth.com/mod/fabric-api/version/0.83.0+1.20) <br> [midnightlib 1.9.2-fabric](https://modrinth.com/mod/midnightlib/version/1.9.2+1.20.1-fabric)     | [architechury-api 9.2.14+forge](https://modrinth.com/mod/architectury-api/version/9.2.14+forge) <br> [midnightlib 1.9.2-neoforge](https://modrinth.com/mod/midnightlib/version/1.9.2+1.20.1-neoforge) |
