[//]: # (Mincrophone Text Input 2.0.1-1.21.5)

## Whats New

- Compatibility with `minecraft 1.21.4` and `minecraft 1.21.5`.
- Add missing translations for file chooser dialog.

## Installation

1. Install `minecraft 1.21.4` or `minecraft 1.21.5`, `fabric loader >=0.16.0`, `fabric-api` and [MidnightLib 1.7.2-fabric](https://modrinth.com/mod/midnightlib/version/1.7.2+1.21.4-fabric).
