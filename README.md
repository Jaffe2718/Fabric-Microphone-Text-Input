...
|---------------------------|-----------------------------------------|----------------------------------------------------------|----------------------------------------------|-----------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| GGML Whisper Model        | `mcmti.midnightconfig.model`            | `me.jaffe2718.mcmti.config.McmtiConfig.model`            | `String`                                     | `"https://huggingface.co/ggerganov/whisper.cpp/resolve/main/ggml-base.bin"` | Path or URL to the GGML Whisper model.                                                     |
...
| whisperSamplingStrategy      | `mcmti.midnightconfig.whisperSamplingStrategy`      | `me.jaffe2718.mcmti.config.McmtiConfig.whisperSamplingStrategy`      | `me.jaffe2718.mcmti.config.McmtiConfig.SamplingStrategy` | `BEAM_SEARCH` | The `SamplingStrategy` enum to configure whisper's sampling strategy.               |
| vad                          | `mcmti.midnightconfig.vad`                          | `me.jaffe2718.mcmti.config.McmtiConfig.vad`                          | `me.jaffe2718.mcmti.config.McmtiConfig.WhisperVad`       | `DISABLED`    | Enable VAD (Voice Activity Detection).                                              |
